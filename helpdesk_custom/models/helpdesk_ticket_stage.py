...
class HelpdeskTicketStage(models.Model):
    ...
    team_ids = fields.Many2many(
        ...
        help="Specific team that uses this stage. If it is empty all teams could use it.",
    ...
    # From helpdesk_mgmt_stage_validation
    validate_field_ids = fields.Many2many(
        comodel_name="ir.model.fields",
        string="Required Fields",
        domain=[("model", "=", "helpdesk.ticket")],
        help="Fields that must be filled in before moving a ticket to this stage.",
    )
